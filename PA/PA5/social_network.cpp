...
void menu() {
  ...
  cout << "6: Write user contents to a file (enter file name on same line)"
       << endl;
  cout << "7: Shortest path (enter both users on the same line)"
       << endl;
  cout << "8: Disjoint sets (only enter the number 8)"
       << endl;
  cout << "9: Suggest friends (enter the user you want friend suggestions for)"
       << endl;
}
